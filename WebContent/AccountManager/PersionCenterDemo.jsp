...
<body>
    ...
    <div id="logoimg">
      ...
      <li>
       <a href="#" id="PersionData" class="AxajGetDataSource"> 个人设置</a>
    ...
    <a href="#" id="ShopOderManager" class="AxajGetDataSource">商城订单</a>
    </div>
    <div class="listTitleContent">
   <a href="#" id="ServiceOderManager" class="AxajGetDataSource"> 服务订单</a>
    </div>
    <div class="listTitleContent">
   <a href="#" id="ExitPorductContent" class="AxajGetDataSource">退货记录</a>
    
    </div>
    <div class="listTitleContent">
  
  <a href="#" id="GetPorductContent" class="AxajGetDataSource">到货记录</a>
    </div>
    <div class="listTitleContent">
     <a href="#" id="ShopCollect" class="AxajGetDataSource">我的收藏</a>
    ...
    <div class="listTitleContent">
   <a href="#" id="PersionAccount" class="AxajGetDataSource">余额</a>
    </div>
    <div class="listTitleContent">
    服务订单
    </div>
   ...
   到货记录
    ...
    <div  class="listTitleContent"><a href="#" id="Coupons" class="AxajGetDataSource">我的优惠券</a></div>
    </div>
   ...
   私信
    ...
    <div class="listTitleContent">
   <a href="#" id="SafetySetting" class="AxajGetDataSource"> 安全设置</a>
    </div>
    <div class="listTitleContent">
    <a href="#" id="Adderss" class="AxajGetDataSource"> 收货地址</a>
    </div>
    <div class="listTitleContent">
    发票抬头
