...
function loads(){
	var granttimeinfo=$("#granttime").val();
	var granttimeArray=granttimeinfo.split("-");
	var Year=0;
	var Month=0;
	var Day=0;
	for(var i=0;i<granttimeArray.length;i++){
		if(i==0){
		Year=granttimeArray[i];
			}
		else if(i==1){
		Month=granttimeArray[i];
			}
		else{
		Day=granttimeArray[i];
			}	
		}
var birthdayoption=document.getElementById("birthday").options;
...
<form action="../HRPayInfoUpdate" method="post">
<div id="rightgl">
<div class="bodytips">
...
<o:if test="${PersonInfo.payid==param.PayID}" var="new">
<div id="baseinfo">
<div class="centerinput">
<div class="usernamedata">薪资编号:
  <input type="text" name="payid" class="input" id="payids" value="${PersonInfo.payid}"></div>
<div class="usernamedata">
员工ID:
  <input type="text" name="epmlyID" class="input" id="epmlyid" value="${PersonInfo.epmlyid}">
</div>
...
基本薪资:
  <input type="text" name="basepaynumber" id="basepayid" class="input" value="${PersonInfo.basicNumber}">
</div>
<div class="usernamedata">饭补:
  <input type="text" class="eatsubsidy" id="eatsubsidyid" name="eatnumber"  value="${PersonInfo.eatNumber}">
</div>
</div>
<div class="centerinput">
<div class="usernamedata">
房补:<input type="text" class="housesubsidy" id="housesubsidyid" name="houesnumber"  value="${PersonInfo.houseNumber}">
...
工资发放日期:年:<select id="birthday" name="year">
        ...
        <input  type="text" id="granttime" value="${PersonInfo.granttim}" style="display:none">
</div>
</div>
<div class="centerinput">
<div class="usernamedata">全勤奖:
  <input type="text" name="perfect" id="perfectid" value="${PersonInfo.scot}">

</div>
<div class="usernamedata">

赋税:<input type="text" name="taxes" id="taxes" value="${PersonInfo.duty}">
</div>
<div class="usernamedata">

额外补助:<input type="text" name="eypay" id="eypayid"  value="${PersonInfo.other}">
</div>
<div class="usernamedata">
罚款:<input type="text" name="reward" id="rewardid"  value="${PersonInfo.rewards}">

</div>
<div class="usernamedata">
总计薪资:<input type="text" name="totalpay" id="totalpayid"  value="${PersonInfo.totalize}">
