...
<o:forEach  items="${sessionScope.AllDateBasePersonInfo}" var="PersonInfo">
...
<div class="userinfo"><a href="../InfoRemove?EmployID=${PersonInfo.employid}" onclick="return confirm('确定删除吗')">删除</a>/<a href="RemployInfoUpdate.jsp?EmployID=${PersonInfo.employid}">修改</a></div>
