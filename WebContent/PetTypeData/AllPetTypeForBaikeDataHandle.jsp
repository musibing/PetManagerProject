...
<link rel="stylesheet" type="text/css"
	href="http://a.boqiicdn.com/Css/public/public_toolbar_baike.css?v=1481794036">
	...
	<div id="conent_control">
		...
		<div id="getData">
			<div id="getDataButton">
				<input id="getUrlSrc" value="获致源代码" type="button"></input> <input
				...
				请你要爬取的分类的英文名称的内容:<br> <input id="" class="ClassificationBottom"
					type="text"> <input id="" class="ClassificationBottom"
					type="text"> <input id="" class="ClassificationBottom"
					type="text"> <input id="" class="ClassificationBottom"
					type="text"> <input id="" class="ClassificationBottom"
					type="text"> <input id="" class="ClassificationBottom"
