	...
	$(function() {
		$(window).load(
				function() {
					...
					var baseicinfoNameCalss = $(
							".basic-info-cmn-clearfix").find("dt");
					...
					alert("Data");
					 $.ajax({
								...
								type:"post",
								data:{"Petdescription":Petdescription,"PetName":PetName,"baseicinfoNameArray":JSON.stringify(baseicinfoNameArray)},
