...
public Employinfo(int employid, String employName, String professional,
		String school, String ecdtion, String emailAddress, String jobinfodata,
		String employinfo, String employTelNumber, int employAge,
		int employSex, int jobstatus, Date createtime, String accountIncoPath,
		int jobID, String idCarNumber) {
	super();
...
public String toString() {
	return "Employinfo [employid=" + employid + ", employName=" + employName
			+ ", professional=" + professional + ", school=" + school
			+ ", ecdtion=" + ecdtion + ", emailAddress=" + emailAddress
			+ ", jobinfodata=" + jobinfodata + ", employinfo=" + employinfo
			+ ", employTelNumber=" + employTelNumber + ", employAge="
			+ employAge + ", employSex=" + employSex + ", jobstatus="
			+ jobstatus + ", createtime=" + createtime + ", accountIncoPath="
			+ accountIncoPath + ", jobID=" + jobID + ", idCarNumber="
			+ idCarNumber + "]";
}
