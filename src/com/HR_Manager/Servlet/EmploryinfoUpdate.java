...
@WebServlet("/EmploryinfoUpdate")
public class EmploryinfoUpdate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=0;
		try {
			result=daointerface.EmplroyInfoUpdate(info);
		} catch (Exception e) {
		...
		String sendpath="";
		if(result!=0){
			sendpath=ProjectPath+"/HRemployManager/RemployInfoView.jsp";
		}else{
