...
@WebServlet("/HRRewardsInfoUpdate")
public class HRRewardsInfoUpdate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			resutl=daoInter.HRRewardsinfoUpdate(rewardsinfo);
		} catch (Exception e) {
			...
			SendPath=FactoryPath+"/HRRewards/HRRewardsinfoUpdate.jsp";
		}
