...
@WebServlet("/HRtrainplanInput")
public class HRtrainplanAdd extends HttpServlet {
	...
	DaoInterface daoInter=Factory.getdaointerface();
		...
		String SendPath="";
		try {
			resutl=daoInter.AddTrainInfo(trainInfo);
		} catch (Exception e) {
			e.printStackTrace();
		}if(resutl!=0){
			SendPath=FactoryPath+"/HRtrain/HRtrainView.jsp";
