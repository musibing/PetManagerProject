...
@WebServlet("/SelectAllPersonInfo")
public class SelectAllPersonInfo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			Maxcount=DaoInter.GetPersonInfoMaxCount();
			...
			AllPersonInfolist=DaoInter.SelectAllPersonInfo(thispage, rows);
		} catch (Exception e) {
			e.printStackTrace();
		}
		String ContextPath=request.getContextPath();
		session.setAttribute("AllPersonInfo", AllPersonInfolist);
		response.sendRedirect(ContextPath+"/HRPersonInfoManager/PersonInfoView.jsp");
