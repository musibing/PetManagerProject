...
@WebServlet("/SelectHREmploryDataBase")
public class SelectHREmploryDataBase extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			AllPersonInfolist=DaoInter.SelectAllHREmploryDataBase(thispage, rows);
		} catch (Exception e) {
		...
		session.setAttribute("AllDateBasePersonInfo", AllPersonInfolist);
		response.sendRedirect(ContextPath+"/HRemployManager/RemployDataBaseView.jsp");
