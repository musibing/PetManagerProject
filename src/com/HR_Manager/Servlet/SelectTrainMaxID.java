...
@WebServlet("/SelectTrainMaxID")
public class SelectTrainMaxID extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql="select max(id) from hrtrain";
		int MaxID=0;
		try {
		...
		response.sendRedirect(FactoryPath+"/HRtrain/HRtrainplanInput.jsp");
